...
description: Run two read-only GPT-5.6 Sol reviewers with high thinking, resolve and re-review fixes in a bounded loop, require pnpm precommit before pushes, and address GitHub review-bot feedback.
---
...
## 4. Have reviewers critique the fixes
